...
class mssql_native_moodle_database extends moodle_database {
    ...
    protected $supports_offset_fetch; // Does the used db version support new version or limiting (2012 and higher)
	...
	$this->supports_offset_fetch = $server_info['version'] > '11';
    ...
    public function get_recordset_sql($sql, array $params=null, $limitfrom=0, $limitnum=0) {
        ...
        if ($limitfrom && !$this->supports_offset_fetch) { // Skip $limitfrom records
